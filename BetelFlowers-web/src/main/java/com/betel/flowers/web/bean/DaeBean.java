...
public class DaeBean implements Serializable {
    ...
    public void modify(ActionEvent evt) {
        if (this.selected != null) {
            Pais mpais = this.paisService.findByCodigo(this.selected.getPais());
    ...
    public DaeService getDaeService() {
        return daeService;
    }

    public void setDaeService(DaeService daeService) {
        this.daeService = daeService;
    }
